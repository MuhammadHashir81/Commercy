...
const SellerLogin = () => {
    const { handleLoginUser, userCredentials, setUserCredentials, handleGoogleLoginSuccess } = useContext(SellerContext)
                ...
                <div className= ' shadow-orange-300  bg-white w-[350px] p-6 rounded-md flex flex-col space-y-3 '>
                    ...
                    <div className='m-auto'>
                        <p>Don't have an account?
                            <NavLink className="text-blue-600  underline" to='/sellersignup'>signup</NavLink>
                        </p>
                    </div>
                </div>
